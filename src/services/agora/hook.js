...
export const useInitializeAgora = () => {
  const appId = 'bbb04e52893646fd90487b4fa83f63ce';
  const token = '007eJxTYGgrlHi26KSF4PRTeu7vPxZa34+s6NMt2PzEYtbEmO6PbWUKDElJSQYmqaZGFpbGZiZmaSmWBiYW5kkmaYkWxmlmxsmpDxewJCd+Yk1+YtrGysgAgSA+O0NuYlViSmoqAwMAMFAjqA==';
  const [channelName, setChannelName] = useState('mazadee');
